...
SecureBank is FinTech application which contains all [OWASP TOP 10](https://owasp.org/Top10/2025/) security vulnerabilities along with some other security flaws found in real-world applications.
